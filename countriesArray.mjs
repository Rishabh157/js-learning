// import countries_data from "./problem-1.mjs";
...
for (let i = 0; i < countries_data.length; i++) {
    ...
    // console.log(countries_data[i].population)
    // console.log(countries_data[i].languages)

    if(countries_data[i].name == "india"){
...
// to find the array is or not
// let ans = Array.isArray(countries_data)
